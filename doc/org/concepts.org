...
| ~state-player~      | ~std::vector<bool>~            | vector indicating whether a state of a parity game / arena is controlled by the environment (f) or the player (t)                                     |
...
| ~winning-region~    | ~std::vector<bool>~            | vector indicating whether a state belongs to the winning region of the environment (f) or the player (t)                                              |
