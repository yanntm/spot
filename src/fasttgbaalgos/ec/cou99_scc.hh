...
#ifndef SPOT_FASTTGBAALGOS_EC_COU99_SCC_HH
# define SPOT_FASTTGBAALGOS_EC_COU99_SCC_HH
...
namespace spot
{
  ...
  class cou99_scc : public ec
  {
  public:

    /// A constructor taking the automaton to check
    cou99_scc(instanciator* i, std::string option = "");
...
#endif // SPOT_FASTTGBAALGOS_EC_COU99_SCC_HH
