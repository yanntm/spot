...
#ifndef SPOT_FASTTGBAALGOS_EC_DIJKSTRA_SCC_HH
# define SPOT_FASTTGBAALGOS_EC_DIJKSTRA_SCC_HH
...
namespace spot
{
  ...
  class SPOT_API dijkstra_scc : public ec
  {
  public:
...
#endif // SPOT_FASTTGBAALGOS_EC_DIJKSTRA_SCC_HH
