...
#ifndef SPOT_FASTTGBAALGOS_EC_COU99CHECK_HH
# define SPOT_FASTTGBAALGOS_EC_COU99CHECK_HH
...
namespace spot
{
  ...
  class cou99check : public ec
  {
  public:

    /// A constructor taking the automaton to check
    cou99check(instanciator* i, std::string option = "");
...
#endif // SPOT_FASTTGBAALGOS_EC_COU99CHECK_HH
