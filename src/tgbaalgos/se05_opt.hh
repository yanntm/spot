...
#ifndef SPOT_TGBAALGOS_SE05_OPT_HH
# define SPOT_TGBAALGOS_SE05_OPT_HH
...
namespace spot
{
  ...
  /// spot::explicit_se05_opt_search.
  ///
  /// \sa spot::explicit_se05_opt_search
  ///
  emptiness_check* bit_state_hashing_se05_opt_search(const tgba *a, size_t size,
						 option_map o = option_map());


  /// \brief Wrapper for the two se05_opt implementations.
  ///
  /// This wrapper calls explicit_se05_opt_search() or
  /// bit_state_hashing_se05_opt_search() according to the \c "bsh" option
  /// in the \c option_map.  If \c "bsh" is set and non null, its value
  /// is used as the size of the hash map.
  emptiness_check* se05_opt(const tgba *a, option_map o);

  /// @}
}

#endif // SPOT_TGBAALGOS_SE05_OPT_HH
