...
namespace spot
{
  ...
  public:
    ...
    virtual state_explicit<int, identity_hash<int> >* clone() const
    {
      return new state_explicit_number(label_);
    }
  };
  ...
  public:
    ...
    virtual state_explicit<const ltl::formula*, ltl::formula_ptr_hash>*
    clone() const
    {
      return new state_explicit_formula(label_);
    }
  };
