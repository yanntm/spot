...
namespace spot
{
  ...
  class SPOT_API stats_dfs: public tgba_reachable_iterator_depth_first
  {
  public:
    stats_dfs(const const_twa_ptr& a, tgba_statistics& s,
	      proviso& proviso, bool dotty = false)
      : tgba_reachable_iterator_depth_first(a), s_(s),
  ...
  private:
    int last; // FIXME ???  last state encountered
    int expanded_;
