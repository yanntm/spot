...
namespace spot
{
  ...
  /// \brief This class implements a swarmed exploration where only
  /// the reduced graph is explored (i.e., no expansion is performed).
  /// It uses a shared store to share information between threads.
  ...
  public:
    ...
    swarmed_none(kripkecube<State, SuccIterator>& sys,
