...
namespace spot
{
  ...
  struct SPOT_API cond_dest_liveness_stats
  {
  ...
  /// \brief This class implements a swarmed cond_dest_liveness as described in
  // ATVA'16. It uses a shared store to share information between threads.
  template<typename State, typename SuccIterator,
           typename StateHash, typename StateEqual>
  class SPOT_API swarmed_cond_dest_liveness
  {
  public:

    swarmed_cond_dest_liveness(kripkecube<State, SuccIterator>& sys,
    ...
    cond_dest_liveness_stats stats()
    {
