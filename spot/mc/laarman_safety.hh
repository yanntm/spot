...
namespace spot
{
  ...
  struct SPOT_API laarman_safety_stats
  {
  ...
  /// \brief This class implements a swarmed laarman_safety as described in
  // ATVA'16. It uses a shared store to share information between threads.
  template<typename State, typename SuccIterator,
           typename StateHash, typename StateEqual>
  class SPOT_API swarmed_laarman_safety
  {
  public:

    swarmed_laarman_safety(kripkecube<State, SuccIterator>& sys,
    ...
    void run()
    {
      ...
      // Insert the initial state
      {
        ...
        todo_.push_back({pair.second, it, true});
