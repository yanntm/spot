...
namespace spot
{
  ...
  /// \brief Encode and print an automaton as an AIGER circuit.
  ///
  /// Mostly the same as print_aiger with certain restrictions/modifications
  /// 1) In order to ensure correctness, edge conditions have to have te form
  ///    (input cond) & (output cond). The output cond does not need to be a
  ///   minterm. Correct graphs are generated by unsplit_2step and
  ///   apply_strategy.
  /// 2) The algorithm has some heuristics to reduce the number of gates in
  ///    the circuit.
  ///
  /// \param os           The output stream to print on.
  /// \param aut          The automaton to output.
