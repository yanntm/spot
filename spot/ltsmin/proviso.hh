...
namespace spot
{
  ...
  // \brief This cycle proviso expand randomly a state between the root
  // and the top of the stack if the destination is on dfs, otherwise it
  // expands randomly a state between the destination and the top of the
  // stack
  class SPOT_API rnd_one_proviso: public proviso
  {
  public:
    bool expand_new_state(int n, bool expanded, twa_succ_iterator*,
			  seen_map&, const state*, const const_twa_ptr&);
  ...
  private:
    ...
    std::unordered_map<int, reach_element> reach_;
    std::vector<bool> expanded_;
    std::vector<bool> to_be_expanded_;
    struct root_element
    {
      int n;
      std::vector<int> same_scc;
  ...
  // \brief This cycle proviso expands the  state with minimal succ between root
  // and the top of the stack if the destination is on dfs, otherwise it
  // expands the state with minimal  between the destination and the top of the
  // stack
  class SPOT_API min_succ_proviso: public proviso
  {
  public:
    bool expand_new_state(int n, bool expanded, twa_succ_iterator* it,
			  seen_map&, const state*, const const_twa_ptr&);
  ...
  // \brief This cycle proviso expands the state with minimal enabled
  // succ between root  and the top of the stack if the destination is on dfs,
  // otherwise it expands the state with minimal  between the destination and
  // the top of the stack
  class SPOT_API min_succ_en_proviso: public proviso
  {
  public:
    bool expand_new_state(int n, bool expanded, twa_succ_iterator* it,
			  seen_map&, const state*, const const_twa_ptr&);
  ...
  // \brief This cycle proviso expands the state with maximal enabled
  // succ between root  and the top of the stack if the destination is on dfs,
  // otherwise it expands the state with maximal  between the destination and
  // the top of the stack
  class SPOT_API max_succ_en_proviso: public proviso
  {
  public:
    bool expand_new_state(int n, bool expanded, twa_succ_iterator* it,
			  seen_map&, const state*, const const_twa_ptr&);
  ...
  // \brief This cycle proviso expands the  state with maximal succ between root
  // and the top of the stack if the destination is on dfs, otherwise it
  // expands the state with maximal  between the destination and the top of the
  // stack
  class SPOT_API max_succ_proviso: public proviso
  {
  public:
    bool expand_new_state(int n, bool expanded, twa_succ_iterator* it,
			  seen_map&, const state*, const const_twa_ptr&);
