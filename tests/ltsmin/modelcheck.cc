...
static int checked_main()
{
  ...
  if (!mc_options.distribute && !BENCH)
    {
  ...
  if (mc_options.distribute)
    {
      ...
      proc->err << "I am following process " << rank << " on host " << host_name
                << std::endl;
    ...
    safe_exit_mpi:
      ...
      if (BENCH)
        ...
        // Displays all displays in writing order.
        proc->print<std::ostream>(std::cout, std::cerr);
