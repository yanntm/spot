...
static int checked_main()
{
  ...
  // FIXME : rework layer of all algorithms
      ...
      if (mc_options.csv)
        {
          ...
          auto sccs = std::min_element(result.sccs.rbegin(),
                                       result.sccs.rend());
  ...
  // --------------------------------------------------------------
    ...
    //     constexpr auto myalgo = spot::mc_algorithm::CNDFS;
    //     auto mytmp = spot::ec_instanciator<spot::ltsmin_kripkecube_ptr,
    //                                        spot::cspins_state,
    //                                        spot::cspins_iterator,
    //                                        spot::cspins_state_hash,
    //                                        spot::cspins_state_equal>
    //       (myalgo, modelcube, propcube);
