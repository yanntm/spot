...
# A1='SE05_dyn,VERIFIED,BA,12,1,0,1,1,"FG ( ¬"Person_1.waiting")"'
# A2='SE05_dyn,VERIFIED,BA,13,0,0,0,"FG ( ¬"Person_1.waiting")"'
# A3='SE05_dyn,VERIFIED,BA,18,0,0,0,"FG ( ¬"Person_1.waiting")"'

# compare_three "$A3" "$A2" "$A1"
